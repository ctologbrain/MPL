                ...
                <div class="tab-pane show active" id="input-types-preview">
                      <div class="row pl-pr mt-1">
                            ...
                            <div class="mb-2 col-md-3">
                                    ...
                                    <input type="submit" name="submit" value="Download" class="btn btn-primary" tabindex="45">
                            </div> 
                            </form>
   ...
   var base_url = '{{url('')}}';
       ...
       success: function(data) {
         ...
         // $('.City').val(obj.emp_present_details.City).trigger('change');
          getCity(obj.emp_present_details.State,obj.emp_present_details.City);
         $('.City').attr('disabled', true);
         // $('.Pincode').val(obj.emp_present_details.Pincode).trigger('change');
          getpincode(obj.emp_present_details.City,obj.emp_present_details.Pincode);
       ...
       //  $('.CityP').val(obj.emp_per_details.City).trigger('change');
         getCityP(obj.emp_per_details.State,obj.emp_per_details.City);
         $('.CityP').attr('disabled', true);
         //$('.PincodeP').val(obj.emp_per_details.Pincode).trigger('change');
         getpincodeP(obj.emp_per_details.City,obj.emp_per_details.Pincode);
