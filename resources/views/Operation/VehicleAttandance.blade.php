                                ...
                                <div class="row pl-pr mt-1">
                                    <div class="col-6">
                                        <div class="col-12 m-b-1">
                                            <div class="row">
                                                <div class="col-12 m-b-1">
                                                    <div class="row"> <label class="col-md-3 col-form-label"
                                                            for="userName">Reporting Date<span
                                                                class="error">*</span></label>
                                                        <div class="col-md-7"> <input type="text" tabindex="1"
                                                                class="form-control datepickerOne rdate" name="rdate"
                                                                id="rdate">
                                                ...
                                                <div class="col-12 m-b-1">
                                                    <div class="row"> <label class="col-md-3 col-form-label"
                                                            for="vehicle_no">Vehicle No<span
                                                                class="error">*</span></label>
                                                        <div class="col-md-7"> 
                                                        <select onchange="getVehicle(this.value);"
                                                                type="text" name="vehicle_no" class="form-control selectBox"
                                                                id="vehicle_no" tabindex="2"> 
                                                            <option value="" >--Select vehicle--</option>
                                                            @foreach($vehicle as $key)
                                                            <option value="{{$key->id}}"> {{$key->VehicleNo}}</option>
                                                            @endforeach
                                                        </select>
                                                        <input value="" type="hidden" name="vehicleId" id="vehicleId"> </div>
                                                    </div>
                                                </div>

                                                <div class="col-12 m-b-1">
                                                    <div class="row"> <label class="col-md-3 col-form-label"
                                                            for="userName">Reporting Type</label>
                                                        <div class="col-md-7"> <select class="form-control selectBox"
                                                                name="reporting_type" id="reporting_type" tabindex="3">
                                                ...
                                                <div class="col-12 m-b-1">
                                                    <div class="row"> <label class="col-md-3 col-form-label"
                                                            for="userName">Reporting Time<span
                                                                class="error">*</span></label>
                                                        <div class="col-md-3"> <input type="time" tabindex="4"
                                                                class="form-control  ReportingTime" name="ReportingTime"
                                                                id="ReportingTime">
                                                            <span class="error"></span>
                                                        </div>
                                                        <label class="col-md-3 col-form-label" for="userName">( 24:00hrs
                                                            Format )</label>
                                                    </div>
                                                </div>
                                                <div class="col-12 m-b-1">
                                                    <div class="row">
                                                        <label class="col-md-3 col-form-label"
                                                            for="userName">Remarks</label>
                                                        <div class="col-md-7">
                                                            <textarea name="Remarks" tabindex="5" id="Remarks"
                                                                class="form-control Remarks" cols="5"
                                                                rows="5"></textarea>
                                                            <span class="error"></span>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="col-10 text-end mt-1">
                                            ...
                                            <input type="button" tabindex="6" value="Save"
                                                onclick="SubmitVehicleAttandence();" class="btn btn-primary btnSubmit "
                                                id="btnSubmit">
                                            <a href="{{url('VehicleAttandance')}}" tabindex="7"
                                    ...
                                    <div class="col-6">
                                        <table class="table table-bordered table-centered mb-1 ml-1 vehicle_table">
                                            <tbody>
                                                <tr>
                                                    <td align="left" class="lblMediumBold possition p-1"
                                                        nowrap="nowrap">Branch Name
                                                    </td>
                                                ...
                                                <tr>
                                                    <td align="left" class="lblMediumBold possition p-1">Vehicle
                                                        Capacity
                                                    </td>
                                                    <td align="left" class="possition p-1">
