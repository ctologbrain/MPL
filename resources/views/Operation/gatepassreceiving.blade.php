                           ...
                           <div class="tab-content b-0 mb-0">
                                <div class="tab-pane active show" id="basictab1" role="tabpanel">
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                <label class="col-md-4 col-form-label" for="userName">Receiving Type<span
                                            ...
                                            <div class="col-12">
                                            <div class="row">
                                                <label class="col-md-4 col-form-label" for="userName">Receiving Office<span
                                            class="error">*</span></label>
                                                <div class="col-md-8">
                                            ...
                                            <div class="col-12">
                                            <div class="row">
                                                <label class="col-md-4 col-form-label" for="userName">Receiving Date<span
                                            class="error">*</span></label>
                                                <div class="col-md-8">
                                            ...
                                            <div class="col-12">
                                            <div class="row">
                                                <label class="col-md-4 col-form-label" for="userName">Gatepass Number<span
                                            class="error">*</span></label>
                                                <div class="col-md-8">
                                            ...
                                            <div class="col-12">
                                            <div class="row">
                                                <label class="col-md-4 col-form-label" for="userName">Supervisor Name<span
                                            class="error">*</span></label>
                                                <div class="col-md-8">
                                            ...
                                            <div class="col-12">
                                            <div class="row">
                                                <label class="col-md-4 col-form-label" for="userName">Remarks<span
                                            class="error">*</span></label>
                                                <div class="col-md-8">
                                            ...
                                            class="error">*</span></label>
                                                <div class="col-md-8">
                                                <input type="text" tabindex="5" class="form-control  DocketNumber" name="DocketNumber" id="DocketNumber" onchange="getDocketDetails(this.value);">
                                                <span class="error"></span>
                                                </div>
                                            </div>
                                            </div>  
                                            <div class="col-12">
                                            <div class="row">
                                                <label class="col-md-4 col-form-label" for="userName">Received Qty<span
                                            class="error">*</span></label>
                                                <div class="col-md-8">
                                                <input type="text" tabindex="5" class="form-control  ReceivedQty" name="ReceivedQty" id="ReceivedQty">
                                                <span class="error"></span>
                                                </div>
                                            </div>
                                            </div>   
                                            ...
                                            <div class="col-4">
                                            <div class="row">
                                                <label class="col-md-5 col-form-label" for="userName">Total</label>
                                                <div class="col-md-8">
                                                <span id="total"></span>
                                                <span class="error"></span>
                                                </div>
                                            ...
                                            <div class="col-4">
                                            <div class="row">
                                                <label class="col-md-5 col-form-label" for="userName">Scan</label>
                                                <div class="col-md-8">
                                                <span id="Scan"></span>
                                                <span class="error"></span>
                                                </div>
                                            ...
                                            <div class="col-4">
                                            <div class="row">
                                                <label class="col-md-5 col-form-label" for="userName">Pending</label>
                                                <div class="col-md-8">
                                            ...
                                            <div class="row">
                                                <label class="col-md-4 col-form-label" for="userName">Document<span
                                            class="error">*</span></label>
                                                <div class="col-md-8">
