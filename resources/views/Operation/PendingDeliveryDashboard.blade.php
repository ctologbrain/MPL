...
<div class="generator-container allLists">
            ...
            <div class="page-title-box main-title">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active"> <a href="{{url('/PendingDeliveryDashboard?submit=Download')}}" class="btn btn-primary text-white">Download</a> </li>
                    </ol>
                </div>
    ...
    <!-- end card-->
          ...
          <tr class="main-title">
            ...
            <th style="min-width:130px;" class="p-1">Vehicle Dispatch Date</th>    
