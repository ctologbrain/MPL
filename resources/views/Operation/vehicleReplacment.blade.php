                                                    ...
                                                    <div class="tab-pane fade show active" id="pills-home"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-6">
                                                                <div class="row mb-1">
                                                                    <div class="col-12 m-b-1">
                                                                        <div class="row">
                                                                            <label class="col-md-4 col-form-label"
                                                                                for="gp_no">GP No<span
                                                                                    class="error">*</span></label>
                                                                            <div class="col-md-8"> <input type="text"
                                                                                    name="gp_number" id="gp_number"
                                                                                    class="gp_number form-control"
                                                                                    tabindex="1"
                                                                                    onchange="getVehiclegatePass(this.value)">
                                                                                <input type="hidden" name="gp_id"
                                                                                    id="gp_id"
                                                                                    class="gp_id gp_idnew form-control">
                                                                                <input type="hidden" name="Vehicle"
                                                                                    id="Vehicle"
                                                                                    class="Vehicle VehicleNew form-control">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-12">
                                                                        <div class="row">
                                                                            <label class="col-md-4 col-form-label"
                                                                                for="vechile_change_city">Incidence<span
                                                                                    class="error">*</span></label>
                                                                            <div class="col-md-8"> <select tabindex="2"
                                                                                    class="form-control Incidence selectBox"
                                                                                    name="Incidence" id="Incidence"
                                                                                    onchange="getFeildAccordIncid(this.value);">
                                                                                    <option value="">--select--</option>
                                                                                    <option value="1">Vehicle
                                                                                        Replacement</option>
                                                                                    <option value="2">Vehicle Breakdown
                                                                                    </option>
                                                                                    <option value="3">In Transit
                                                                                    </option>
                                                                                </select>
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <div class="col-12 vechile_change_hide">
                                                                        <div class="row">
                                                                            <label class="col-md-4 col-form-label"
                                                                                for="vechile_change_city">Vehicle Change
                                                                                City<span class="error">*</span></label>
                                                                            <div class="col-md-8">
                                                                                <select tabindex="2"
                                                                                    class="form-control vechile_change_city selectBox"
                                                                                    name="vechile_change_city"
                                                                                    id="vechile_change_city" value=""
                                                                                    onclick="">
                                                                                    <option value="">--select--</option>
                                                                    ...
                                                                    <div class="col-12 new_vechile_hide">
                                                                        <div class="row">
                                                                            <label class="col-md-4 col-form-label"
                                                                                for="new_vechile_number">New Vehicle
                                                                                Number<span
                                                                                    class="error">*</span></label>
                                                                            <div class="col-md-8">
                                                                                <select tabindex="3"
                                                                                    class="form-control new_vechile_number selectBox"
                                                                                    name="new_vechile_number"
                                                                                    id="new_vechile_number">
                                                                                    <option value="">--select--</option>
                                                                                    @foreach($VehicleMaster as $vehicle)
                                                                                    <option value="{{$vehicle->id}}">
                                                                                        {{$vehicle->VehicleNo}}</option>
                                                                                    @endforeach
                                                                                </select>
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <div class="col-12 new_driver_hide">
                                                                        ...
                                                                        <div class="row">
                                                                            <label class="col-md-4 col-form-label"
                                                                                for="new_driver_name">New Driver
                                                                                Name<span class="error">*</span></label>
                                                                            <div class="col-md-8">
                                                                                <select tabindex="4"
                                                                                    class="form-control new_driver_name selectBox"
                                                                                    name="new_driver_name"
                                                                                    id="new_driver_name">
                                                                                    <option value="">--select--</option>
                                                                                    @foreach($DriverMaster as $driver)
                                                                                    <option value="{{$driver->id}}">
                                                                                        {{$driver->DriverName}}~{{$driver->License}}
                                                                                    </option>
                                                                                    @endforeach
                                                                                </select>
                                                                    ...
                                                                    <div class="col-12 reasonhide">
                                                                        ...
                                                                        <div class="row">
                                                                            <label class="col-md-4 col-form-label"
                                                                                for="reason">Reason<span
                                                                                    class="error">*</span></label>
                                                                            <div class="col-md-8">
                                                                                <select tabindex="5"
                                                                                    class="form-control reason selectBox"
                                                                    ...
                                                                    <div class="col-12 start_km_hide">
                                                                        ...
                                                                        <div class="row">
                                                                            <label class="col-md-4 col-form-label"
                                                                                for="start_km">Start Km<span
                                                                                    class="error">*</span></label>
                                                                            <div class="col-md-8">
                                                                                <input type="text" tabindex="6"
                                                                                    class="form-control start_km"
                                                                                    name="start_km" id="start_km"
                                                                                    value="">
                                                                    ...
                                                                    <div class="col-12 mt-1 mb-1">
                                                                        <label class="col-md-4 col-form-label pickupIn"
                                                                            for="password"></label>
                                                                        <input type="hidden" name="pickup"
                                                                            class="pickup" id="pickup">
                                                                        <input type="button" tabindex="8" value="Save"
                                                                            class="btn btn-primary btnSubmit"
                                                                            id="btnSubmit"
                                                                            onclick="SubmitVehicleReplacment()">
                                                                        <a href="{{url('VehicleReplacement')}}"
                                                                            tabindex="9"
                                                            ...
                                                            <div class="col-6">
                                                                ...
                                                                <table
                                                                    class="table table-bordered table-centered mb-1 ml-1 gatepassreceiving-table topay_table">
                                                                    <tbody>
                                                                        <tr class="back-color">
                                                                        ...
                                                                        <tr>
                                                                            <td align="left"
                                                                                class="lblMediumBold possition back-color p-1"
                                                                                nowrap="nowrap">GP Date
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            <td align="left"
                                                                                class="lblMediumBold possition Origin back-color p-1"
                                                                                nowrap="nowrap">Origin
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            <td align="left"
                                                                                class="destination back-color p-1">
                                                                                Destination
                                                                            </td>
                                                                            <td align="left" colspan="3" class="p-1">
                                                                        ...
                                                                        <tr>
                                                                            <td align="left"
                                                                                class="lblMediumBold possition vendor back-color p-1"
                                                                                nowrap="nowrap">Vendor
                                                                            </td>
                                                                            <td align="left" colspan="3" class="p-1">
                                                                                <span id="vendor"></span>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            <td align="left"
                                                                                class="lblMediumBold possition vechile_nVechile Number back-color p-1">
                                                                                Vehicle Number
                                                                            </td>
                                                                            <td align="left" class="p-1">
                                                                                <span
                                                                                    id="vechile_number_display"></span>
                                                                            </td>
                                                                            <td align="left"
                                                                                class="lblMediumBold possition seal_number back-color p-1"
                                                                                nowrap="nowrap">Seal Number
                                                                            </td>
                                                                            <td align="left" class="p-1">
                                                                        ...
                                                                        <tr>
                                                                            <td align="left"
                                                                                class="lblMediumBold possition driver_name back-color p-1">
                                                                                Driver Name
                                                                            </td>
                                                                            <td align="left" class="ndr_reason p-1"
                                                                                colspan="3">
                                                                        ...
                                                                        <tr>
                                                                            <td align="left"
                                                                                class="lblMediumBold possition advanceToDrive back-color p-1">
                                                                                Advance To Drive
                                                                            </td>
                                                                            ...
                                                                            <td align="left"
                                                                                class="lblMediumBold possition start_km back-color p-1">
                                                                                Start Km
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="left"
                                                                                class="lblMediumBold possition reamrks back-color p-1">
                                                                                Remarks
                                                                            </td>
                                                                            <td align="left" class="topay_amount p-1"
                                                                                colspan="3">
