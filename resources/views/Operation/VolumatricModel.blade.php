<div class="modal fade" id="VolumaticModel" data-bs-backdrop="static" 
      ...
      <div class="modal-dialog modal-lg">
        ...
        <tfoot>
            <tr>
                <td colspan="6"> 
                    <p>Customer Inch Formula : @if(isset($valumatricInc->DevideBy))((Length * Width * Height) / {{$valumatricInc->DevideBy}}) * {{$valumatricInc->MultipleBy}}@else{{'Formula Not Define !'}}@endif</p>
                    <p>Customer Centimeter Formula : @if(isset($valumatricCen->DevideBy))((Length * Width * Height) / {{$valumatricCen->DevideBy}}) * {{$valumatricCen->MultipleBy}}@else{{'Formula Not Define !'}}@endif</p>  
                </td>
            </tr>
            <tr>
