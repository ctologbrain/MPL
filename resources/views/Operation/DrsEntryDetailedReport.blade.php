    ...
    <!-- end card-->
         ...
         <tbody>
            ...
            <tr>
             ...
             <td class="p-1"> {{$key->DRSDatasDetails->DRS_No}}</td>
             ...
             <td  class="p-1"> <a href="#">@if(isset($key->DRSDocketDataDeatils->BookignTypeDetails->title)){{$key->DRSDocketDataDeatils->BookignTypeDetails->title}} @endif </a></td>
