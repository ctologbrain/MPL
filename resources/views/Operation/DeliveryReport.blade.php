         ...
         <tbody>
            ...
            <tr>
             ...
             <td class="p-1">@isset($key->RagularDocketDetails->offcieDetails->OfficeCode) {{$key->RagularDocketDetails->offcieDetails->OfficeCode}} ~ {{$key->RagularDocketDetails->offcieDetails->OfficeName}} @endisset</td>
              ...
              <td class="p-1">@isset($key->RagularDocketDetails->PincodeDetails->CityDetails->ZoneDetails->ZoneName) {{$key->RagularDocketDetails->PincodeDetails->CityDetails->ZoneDetails->ZoneName}} - {{$key->RagularDocketDetails->DestPincodeDetails->CityDetails->ZoneDetails->ZoneName}} @endisset</td>
