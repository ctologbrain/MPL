                                    ...
                                    <div class="col-7">
                                        <div class="row">
                                            ...
                                            <div class="col-12 m-b-1">
                                                <div class="row">
                                                    <label class="col-md-2 col-form-label" for="challan_type">Challan Type<span class="error">*</span></label>
                                                    <div class="col-md-10">
                                        ...
                                        <table class="table-responsive table-bordered">
                                            <thead>
                                                <tr class="main-title text-dark">
                                                    <th class="p-1 td1" colspan="2" style="min-width: 250px;">Pickup/Delivery/Transhipment Detail<span class="error">*</span></th>
                                                    <th class="p-1 td2" style="min-width: 100px;">Transaction Type</th>
                                                    <th class="p-1 td3" style="min-width: 100px;"></th>
                                                    <th class="p-1 td4" style="min-width: 150px;">Payment Mode & Number</th>
                                                    <th class="p-1 td5" style="min-width: 200px;">Paid By Office</th>
                                                </tr>
                                            </thead> 
                                            <tbody>
                                                <tr>     
                                                    <td class="p-1">
                                                        <label class="" for="vechile_number">Number<span class="error">*</span></label>
                                                    </td>
                                                    <td class="p-1"><input type="text" step="0.1" name="number" tabindex="14" class="form-control number" id="number"> 
                                                    </td>
                                                    <td class="p-1">
                                                      <label class="" for="vechile_number">Total Amount<span class="error">*</span></label>      <input type="hidden" step="0.1" name="weight" tabindex="15" class="form-control weight" id="weight" readonly="">
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="p-1" >
                                                        ...
                                                        <div style="width: 48%;">
                                                             <select tabindex="15" class="form-control selectBox mr-1" name="PaymentMode" id="PaymentMode" style="width: 118.625px;">
                                                                <option value="">--select--</option>
                                                    ...
                                                    <td class="p-1">
                                                        <select tabindex="17" class="form-control selectBox AdvOffice" name="AdvOffice" id="AdvOffice" style="width: 198.635px;">        
                                                        <option value="">--select--</option>                @foreach($Office as $key)        
                                                        <option value="{{$key->id}}">{{$key->OfficeCode}} ~ {{$key->OfficeName}}</option>
                                                        @endforeach
                                                         </select>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="p-1">
                                                        <div style="display:flex;">
                                                        <div style="width: 48%;">
                                                            <select tabindex="19" class="form-control selectBox BalPaymentMode" name="BalPaymentMode" id="BalPaymentMode" style="width: 118.625px;">
                                                            <option value="">--select--</option>
                                                            <option value="BANK">BANK</option>
                                                            <option value="CASH">CASH</option>
                                                            <option value="UPI">BANK</option>
                                                    ...
                                                    <td class="p-1">        
                                                        <select tabindex="21" class="form-control selectBox BalOffice" name="BalOffice" id="BalOffice" style="width: 198.635px;">       
                                                        <option value="">--select--</option>@foreach($Office as $key)       
