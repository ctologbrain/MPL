    ...
    <?php $i=0; ?>
        ...
        <td><input type="text" class="form-control awb_number" name="docket[{{$i}}][docket]" id="awb_number" tabindex="5" value="{{$Docket->Docket_No}}"></td>
            ...
            <td><input type="text" class="form-control proof_detail" name="docket[{{$i}}][proof_detail]" id="proof_detail"
                    tabindex="14"></td>
            <td>
                <select disabled name="docket[{{$i}}][ndr_reason]" tabindex="15" class="form-control selectBox ndr_reason" id="ndr_reason{{$i}}">
                    <option value="">--select--</option>
            ...
            <td><input readonly type="text" class="form-control ndr_remark" name="docket[{{$i}}][ndr_remark]" id="ndr_remark{{$i}}" tabindex="16"></td>
