        ...
        <div id="container">
            <table  style="border-collapse: collapse;font-size: 11px;width:100%;">
                ...
                <tr>
                    ...
                    <th style="padding:2px;border-left: none;border-right: 1px solid #000;border-bottom: 1px solid #000;border-top:1px solid #000;min-width: 12px;">S. No.</th>
                    <th style="padding:2px;border:1px solid #000;min-width: 40px;">LR No</th>
                    <th style="padding:2px;border:1px solid #000;min-width: 10px;">Pcs</th>
                    <th style="padding:2px;border:1px solid #000;min-width: 40px;">Charge Weight</th>
                    <th style="padding:2px;border:1px solid #000;min-width: 40px;">GP Weight</th>
                    <th style="padding:2px;border:1px solid #000;min-width: 50px;">Dest.</th>
                    <th style="padding:2px;border:1px solid #000;min-width: 50px;">Consignor</th>
                    <th style="padding:2px;border:1px solid #000;min-width: 50px;">Consignee</th>
                    <th style="padding:2px;border:1px solid #000;min-width: 50px;">Invoice ID</th>
                    <th style="padding:2px;border:1px solid #000;min-width: 50px;">Contents</th>
                    <th style="padding:2px;border:1px solid #000;min-width: 50px;">Value Of Goods</th>
                    <th style="padding:2px;border-left:1px solid #000;border-top:1px solid #000;border-bottom:1px solid #000;border-right:0px solid #000;min-width: 80px;">e-WayBill</th>
               ...
               <?php $i++; ?>
                <tr>
                    <td style="padding:2px;border-left: none;border-right: 1px solid #000;border-bottom: 1px solid #000;border-top:1px solid #000;text-align: center;">{{$i}}</td>
                    <td style="padding:2px;border:1px solid #000;text-align: center;">{{$docketAllDetails->Docket_No}}</td>
                    <td style="padding:2px;border:1px solid #000;text-align: center;">{{$docketAllDetails->pieces}}</td>
                    <td style="padding:2px;border:1px solid #000;text-align: center;">{{$docketAllDetails->weight}}</td>
                    <td style="padding:2px;border:1px solid #000;text-align: center;">{{$docketAllDetails->Actual_Weight}}</td>
                    <td style="padding:2px;border:1px solid #000;text-align: center;">{{$docketAllDetails->CityName}}</td>
                    <td style="padding:2px;border:1px solid #000;text-align: center;">{{$docketAllDetails->ConsignorName}}</td>
                    <td style="padding:2px;border:1px solid #000;text-align: center;">{{$docketAllDetails->ConsigneeName}}</td>
                    ...
                    <td style="padding:2px;border:1px solid #000;text-align: center;">@isset($expUniqueDesc[0]) {{$expUniqueDesc[0]}} @endisset</td>
                    <td style="padding:2px;border:1px solid #000;text-align: center;"> @isset($expUniqueAmount[0]) {{number_format($expUniqueAmount[0],2,".","")}} @endisset</td>
                    <td style="padding:2px;border-left:1px solid #000;border-top:1px solid #000;border-bottom:1px solid #000;border-right:0px solid #000;text-align: center;"> @isset($expUniqueEWayBill[0]) {{$expUniqueEWayBill[0]}} @endisset</td>
                </tr>
             
                @if(isset($TotalCount) && $TotalCount > 0)
                        @for($j=1; $j < $TotalCount; $j++ )
                        <tr>
                            <td style="padding:2px;border-left: none;border-right: 1px solid #000;border-bottom: 1px solid #000;border-top:1px solid #000;"> </td>
                            <td style="padding:2px;border:1px solid #000; text-align: center;"></td>
                            ...
                            <td style="padding:2px;border:1px solid #000;"></td>
                            <td style="padding:2px;border:1px solid #000;"></td>
                            <td style="padding:2px;border:1px solid #000; text-align: center;">{{$expUnique[$j]}}</td>
                            <td style="padding:2px;border:1px solid #000; text-align: center;"> @isset($expUniqueDesc[$j]) {{$expUniqueDesc[$j]}} @endisset</td>
                            <td style="padding:2px;border:1px solid #000; text-align: center;"> @isset( $expUniqueAmount[$j]) {{number_format($expUniqueAmount[$j],2,".","")}}  @endisset</td>
                            <td style="padding:2px;border:1px solid #000; text-align: center;"> @isset($expUniqueEWayBill[$j]) {{$expUniqueEWayBill[$j]}} @endisset</td>
