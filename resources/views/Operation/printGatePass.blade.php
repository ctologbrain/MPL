        ...
        <div class="upperTable">
            <table class="table1" style="border-collapse: collapse;font-size: 12px;"width="100%;">
                ...
                <tr>
                    ...
                    <td style="paddin:5px;border-right: none;border-left: 1px solid #000;border-top: 1px solid #000;border-bottom: 1px solid #000;"  colspan="2">{{$gatePassDetails->DriverDetails->DriverName}} ({{$gatePassDetails->DriverDetails->Phone}})</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="paddin:5px;border:1px solid #000;">AHMEDABAD-VADODARA-SURAT-VAPI-BHIWA</td>
