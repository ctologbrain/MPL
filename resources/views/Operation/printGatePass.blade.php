    ...
    <div id="container">
        <table  style="border-collapse: collapse;font-size: 10px;width:100%;">
            ...
            <tr>
                ...
                <th style="padding:2px;border-left: none;border-right: 1px solid #000;border-bottom: 1px solid #000;border-top:1px solid #000; min-width:20px;">S. No.</th>
                <th style="padding:2px;border:1px solid #000; min-width:20px;">LR No</th>
                <th style="padding:2px;border:1px solid #000; min-width:20px;">Pcs</th>
                ...
                <th style="padding:2px;border:1px solid #000;  min-width:40px;">Contents</th>
                <th style="padding:2px;border:1px solid #000;  min-width:40px;">Value Of Goods</th>
                <th style="padding:2px;border-left:1px solid #000;border-top:1px solid #000;border-bottom:1px solid #000;border-right:0px solid #000; min-width:40px;">e-WayBill</th>
