                                    ...
                                    <div class="bdr-btm">
                                        <div class="row pl-pr">
                                            <div class="col-6 mt-1 m-b-1">
                                                <div class="row">
                                                    <label class="col-md-3 col-form-label" for="holiday_name">Holiday Name<span class="error">*</span></label>
                                                    <div class="col-md-8">
                                                     <input type="text" name="holiday_name" class="form-control holiday_name" id="holiday_name" tabindex="1">
                                                    </div>
                                                </div>
                                            </div>
                                           

                                            <div class="col-6 text-start mt-1 mb-1">
                                          ...
                                          <div class="row mt-1">
                                            <div class="col-6 text-start">
                                              <div class="row">
                                                <label class="col-md-3 col-form-label" for="holiday_name">Search By Name</label>
                                                <div class="col-md-6">
                                              <input type="text" tabindex="4" name="name" class="form-control name" id="name">
                                              </div>
                                               <div class="col-md-3">
                                               <input type="button" tabindex="5" value="Go" class="btn btn-primary btnSubmit" id="btnSubmit" onclick="">
                                              </div>
                                            </div>
                                            </div>
                                             <div class="col-6 text-end">
                                              <input type="button" tabindex="6" value="Export" class="btn btn-primary btnSubmit" id="btnSubmit" onclick="">
                                            </div>
                                              ...
                                              <div class="table-responsive a">
                                                <table class="table table-bordered">
                                                  ...
                                                  <tr>
                                                    ...
                                                    <td class="p-1 text-start">BAKRID / EID AL ADHA</td>
