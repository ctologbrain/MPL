            ...
            <div class="page-title-box main-title">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">STATUS UPDATION</li>
                    </ol>
                </div>
                <h4 class="page-title">STATUS UPDATION</h4>
                            ...
                            <div class="tab-content b-0 mb-0">
                                <div class="tab-pane active show" id="basictab1" role="tabpanel">
                                        ...
                                        <div class="row">
                                            <div class="col-4">
                                                <div class="row">
                                                  <label class="col-md-3 col-form-label mt-1" for="file">Select File</label>
                                                  <div class="col-md-8 mt-1">
                                                     <input type="file" name="file" class="form-control file" tabindex="1">
                                                  </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-5 text-center">
                                                             <input type="button" tabindex="2" value="Upload"
                                                            class="btn btn-primary btnSubmit" id="btnSubmit"
                                                            onclick="">
                                                             
                                                              <a href="" tabindex="3"
                                                            class="btn btn-primary">Reset</a>
                                                            <a href="" style="color: orange;text-decoration: underline;" tabindex="4">Download Sample</a>
                                            </div>
