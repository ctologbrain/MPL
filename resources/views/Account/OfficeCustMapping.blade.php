                    ...
                    <div class="tab-content">
                        <div class="tab-pane show active" id="input-types-preview">
                            <div class="row">
                                ...
                                <div class="mb-2 col-md-4">
                                    <label for="example-select" class="form-label">Pickup Office Name<span
                                            class="error">*</span></label>
                                    <select class="form-control Office selectBox" name="Office" id="Office" tabindex="1">
                                        <option value=""></option>
                                ...
                                <div class="mb-2 col-md-12 text-center">
                                    ...
                                    <a href="{{url('OfficeCustMapping')}}" class="btn btn-primary" tabindex="4">Cancel</a>
                                </div>
                                ...
                                <table class="table table-bordered table-centered mb-1 mt-1">
                                    <thead>
                                        <tr class="main-title text-dark">
                                            ...
                                            <th width="10%" class="p-1">Office</th>
...
function viewState(id) {
    ...
    $.ajax({
        ...
        url: base_url + '/OfficeCustDetails',
        cache: false,
        data: {
            'id': id
        },
        success: function(data) {
            ...
            $('.Customer').val(obj.CustomerId).trigger('change');
