         ...
         <tbody>
            ...
            <tr>
             ...
             <?php  $chCount=1; ?>
              ...
              <?php
            //  $pushtotalAmount += $jk.$DockBookData->CID;
            ...
            <?php
             if( count($monthWiseFixed) >0){
               $Result = number_format($totalAmount/$chCount,2 ,".","");
             }
             else{
              $Result = 0.00;
             }
              ?>
            <td class="p-1"> {{$Result}}</td>
            @if( count($monthWiseFixed) >0)
            <?php $vals= number_format(end($monthWiseFixed)-$Result,2 ,".",""); ?>
            @if($vals < 0)
