...
<div class="generator-container allLists">
    ...
    <!-- end card-->
              ...
              <div class="tab-content">
                <div class="tab-pane show active" id="input-types-preview">
                   ...
                   <div class="mb-2 col-md-3">
                           ...
                           <a href="{{url('CancelInvoiceReport')}}"  class="btn btn-primary" tabindex="5">Reset</a>
                          </div> 
                    </form>
                    <div class="col-12">
          ...
          <tr class="main-title text-dark">
            ...
            <th style="min-width:150px;" class="p-1">Cancelled On</th>
            <th style="min-width:150px;" class="p-1">Cancel Remarks</th>
          </tr>
         </thead>
         <tbody>
             <?php $i=0; 
            ...
            ?>
             ...
             <tr>
                 ...
                 <td class="p-1">{{$i}}</td>
                 <td class="p-1">@isset($inv->InvDate){{date("d-m-Y",strtotime($inv->InvDate))}} @endisset</td>
                 ...
                 <td class="p-1">{{date("d-m-Y" ,strtotime($inv->updated_at))}}</td>
                 <td class="p-1">{{$inv->Cancel_Remark}}</td>
            </tr>
             @endforeach
        </tbody>
         </table>
