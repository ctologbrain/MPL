     ...
     function submitPickupSacn(Request $request)
     {
       ...
       if(isset($checkDocket->Docket_No))
       {
         if($checkDocket->Status==0)
         {
            ...
            $string = "<tr><td>PICKUP SCAN</td><td>".date("d-m-Y",strtotime($PickpSabdScanInv->ScanDate))."</td><td><strong>PICKUP NUMBER: </strong>$PickpSabdScanInv->PickupNo<br><strong>SCAN DATE: </strong>".date("d-m-Y",strtotime($PickpSabdScanInv->ScanDate))."<br><strong>VEHICLE TYPE: </strong>$PickpSabdScanInv->vehicleType<br><strong>VENDOR NAME: </strong>$PickpSabdScanInv->VendorName<br><strong>VEHICLE NUMBER: </strong>$PickpSabdScanInv->VehicleNo ~ $PickpSabdScanInv->Vtype<br><strong>DRIVER NAME: </strong>$PickpSabdScanInv->DriverName<br><strong>START KM: </strong>$PickpSabdScanInv->startkm<br><strong>END KM: </strong>$PickpSabdScanInv->endkm<br><strong>UNLOADING SUPERVISOR NAME: </strong>$PickpSabdScanInv->unloadingSupervisorName<br><strong>PICKUP PERSON NAME: </strong>$PickpSabdScanInv->pickupPersonName</td><td>".date('d-m-Y H:i:s')."</td><td>".$PickpSabdScanInv->EmployeeName."(".$PickpSabdScanInv->OfficeCode.'~'.$PickpSabdScanInv->OfficeName.")</td></tr>"; 
