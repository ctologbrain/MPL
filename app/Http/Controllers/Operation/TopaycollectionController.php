...
class TopaycollectionController extends Controller
{
    ...
    public function getDocketInformation(Request $request){
        $dockInfo=  DocketMaster::with('customerDetails','DestPincodeDetails','PincodeDetails','DocketProductDetails','BookignTypeDetails',"ToPayCollectionDetails")->where("Docket_No",$request->Docket)
