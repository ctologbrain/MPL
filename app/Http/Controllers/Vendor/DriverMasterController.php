    ...
    public function store(StoreDriverMasterRequest $request)
    {
        ...
        if(isset($request->did) && $request->did !='')
        {
            ...
            DriverMaster::where("id", $request->did)->update(
                ['DriverName' => $request->DriverName,'VendorName'=> $request->VendorName,'License'=>$request->License,'LicenseExp'=>$request->LicenseExp,'Address1'=>$request->Address1,'Address2'=>$request->Address2,'City'=>'','Pincode'=>$request->Pincode,'State'=>'','Phone'=>$request->Phone,'image'=>$link]
               );
        }
        else{
            DriverMaster::where("id", $request->did)->update(
                ['DriverName' => $request->DriverName,'VendorName'=> $request->VendorName,'License'=>$request->License,'LicenseExp'=>$request->LicenseExp,'Address1'=>$request->Address1,'Address2'=>$request->Address2,'City'=>'','Pincode'=>$request->Pincode,'State'=>'','Phone'=>$request->Phone]
               );
        }
