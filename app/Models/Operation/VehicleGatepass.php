...
class VehicleGatepass extends Model
{
    ...
    {
        return $this->hasManyThrough(\App\Models\Operation\GatePassWithDocket::class,\App\Models\Operation\VehicleGatepass::class,'id','GatePassId')->with('DestofficeDetails','getAllocationDetail','getDocketMasterDetail');
    }
