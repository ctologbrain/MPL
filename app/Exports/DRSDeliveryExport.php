    ...
    public function collection()
    {
       ...
       ->leftjoin('RTO_Trans','RTO_Trans.Initial_Docket','DRS_Transactions.Docket_No')
        ...
        DB::raw("COUNT(DISTINCT RTO_Trans.Initial_Docket) as TotRTO"),
         ...
         DB::raw("COUNT(DISTINCT DRS_Transactions.DRS_No) - COUNT(DISTINCT CASE WHEN drs_delivery_transactions.Type='DELIVERED' THEN drs_delivery_transactions.Docket END) as TotPanding"),
