...
class NDRDashbordReportExport implements FromCollection, WithHeadings, ShouldAutoSize
{
    ...
    */
    ...
    public function collection()
    {
       ...
       DB::raw("(CASE WHEN NDR_Trans.NDR_Date IS NOT NULL THEN DATE_FORMAT(NDR_Trans.NDR_Date,'%d-%m-%Y') WHEN drs_delivery_transactions.Time IS NOT NULL THEN  DATE_FORMAT(drs_delivery_transactions.Time,'%d-%m-%Y')   END) as NDate"),
      ...
      // WHEN drs_delivery_transactions.Time!='' 
      ->get();
    }
