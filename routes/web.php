...
Route::get('/FreightErrorDashboard', [App\Http\Controllers\Account\AccountMasterController::class, 'FreightErrorDashboard'])->name('FreightErrorDashboard');
...
Route::get('/MultipleDocketTrackingExport', [App\Http\Controllers\Operation\MultipleDocketTrackingController::class, 'MultipleDocketTrackingExport'])->name('MultipleDocketTrackingExport');
...
Route::POST('/AddNewDocketInvoice', [App\Http\Controllers\Operation\EditDocketBookingController::class, 'AddNewDocketInvoice'])->name('AddNewDocketInvoice');
